   ...
   <?php  $this->load->view('layout_admin/menu_samping');?>
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <h1>
          Data Rute
          <small>(Semua Rute yang Tersedia)</small>
        </h1>
        <ol class="breadcrumb">
          <li><a href="<?php echo base_url('admin'); ?>"><i class="fa fa-dashboard"></i> Home</a></li>
          <li class="active"><a href="<?php echo base_url('admin/data_rute'); ?>">Data Rute</a></li>
        </ol>
      </section>
                ...
                <table id="data_rute" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><?php echo $rute->depart; ?></td>
                      <td><?php echo $rute->arrive; ?></td>
                      ...
                      <td>
                        <a href=<?php echo base_url("crud/edit_rute/".$rute->id); ?> class="btn btn-success a-btn-slide-text">
                          <span class="glyphicon glyphicon-edit" aria-hidden="true"></span>
                          <span><strong>Edit</strong></span>            
                        </a>
                        <a href=<?php echo base_url("crud/hapus_rute/".$rute->id); ?> class="btn btn-danger a-btn-slide-text">
