              ...
              <div class="box-body">
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                  ...
                  <input type="password" class="form-control" name="password" value=<?php echo base64_decode($u->password);?> />
                </div>
                <div class="form-group">
                  <label>Level</label>
                  <select class="form-control" name="level">
                    <option value="-">-- SELECT LEVEL --</option>
                    <option <?php if($u->level==='0'){echo "selected";} ?> value="admin">Admin</option>
                    <option  <?php if($u->level==='1'){echo "selected";} ?> value="user">User</option>
                  </select>
                </div>
              </div>
              <!-- /.box-body -->
