   ...
   <?php  $this->load->view('layout_admin/menu_samping');?>
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <h1>
          Data Customer
          <small>(Pelanggan Setia Kita)</small>
        </h1>
        <ol class="breadcrumb">
          <li><a href="<?php echo base_url('admin'); ?>"><i class="fa fa-dashboard"></i> Home</a></li>
          <li class="active"><a href="<?php echo base_url('admin/data_customer'); ?>">Data Customer</a></li>
        </ol>
      </section>
                ...
                <table id="data_customer" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <a href=<?php echo base_url("crud/edit_customer/".$c->id); ?> class="btn btn-success a-btn-slide-text">
                          <span class="glyphicon glyphicon-edit" aria-hidden="true"></span>
                          <span><strong>Edit</strong></span>            
                        </a>
                        <a href=<?php echo base_url("crud/hapus_customer/".$c->id); ?> class="btn btn-danger a-btn-slide-text">
