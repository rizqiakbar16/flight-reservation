									...
									<div class="col-xs-12">
										<div class="form-group">
											...
											<select class="form-control" name="class">
												...
												<option <?php if($r->class==='First'){echo "selected";} ?> value="First">First</option>
												<option <?php if($r->class==='Economy'){echo "selected";} ?> value="Economy">Economy</option>
											</select>
										</div>
									</div>
									<div class="col-xs-12">
