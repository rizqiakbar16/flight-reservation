					...
					<div class="row">
						<div class="col-md-6 col-md-offset-3 text-center">
							<p class="fh5co-social-icons">
								<a target="blank" href="https://twitter.com/kennniexx"><i class="icon-twitter2"></i></a>
								<a target="blank" href="https://www.facebook.com/asg.gilang"><i class="icon-facebook2"></i></a>
								<a target="blank" href="https://www.instagram.com/asg_gilang/"><i class="icon-instagram"></i></a>
							</p>
							<p>Copyright 2018 NCTicketing. All Rights Reserved. <br>Made with <i class="icon-heart3"></i> by <a href="https://github.com/amelsuryagumilang" target="_blank">ASG</a></p>
						</div>
					</div>
				</div>
			</div>
